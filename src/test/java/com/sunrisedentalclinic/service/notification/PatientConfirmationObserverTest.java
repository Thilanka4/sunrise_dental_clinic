...
class PatientConfirmationObserverTest {
    ...
    @BeforeEach
    void setUp() {
        logger = (Logger) LoggerFactory.getLogger(PatientConfirmationObserver.class);
    ...
    @Test
    void onAppointmentBooked_logsConfirmationWithPatientNameAndAppointmentNumber() {
        ...
        new PatientConfirmationObserver().onAppointmentBooked(appointment);
